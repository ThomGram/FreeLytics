...
class TestFreeworkSpiderParsing(unittest.TestCase):
    ...
    def test_parse_job_listings(self):
        ...
        """
        # Create a response with proper request metadata
        ...
        # Check that metadata is passed through
        self.assertEqual(request.meta["job_category"], "data-scientist")
